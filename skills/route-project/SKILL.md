---
name: route-project
description: "Declare this turn's routing lane as oh-my-project. The invocation itself is the verdict — it replaces the visible ROUTE line and puts the lane on the HUD."
argument-hint: "<one-line reason for this lane>"
---

# Lane: oh-my-project

project folder governance — structure, naming, placement, dataset registry.
