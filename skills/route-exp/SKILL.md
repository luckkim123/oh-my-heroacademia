---
name: route-exp
description: "Declare this turn's routing lane as oh-my-experiments. The invocation itself is the verdict — it replaces the visible ROUTE line and puts the lane on the HUD."
argument-hint: "<one-line reason for this lane>"
---

# Lane: oh-my-experiments

experiment analysis and design — run analysis, next-probe proposals, exp loops.
