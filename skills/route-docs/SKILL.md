---
name: route-docs
description: "Declare this turn's routing lane as oh-my-docs. The invocation itself is the verdict — it replaces the visible ROUTE line and puts the lane on the HUD."
argument-hint: "<one-line reason for this lane>"
---

# Lane: oh-my-docs

document artifacts — pptx, docx, xlsx, hwpx, repo-docs, site.
