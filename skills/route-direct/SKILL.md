---
name: route-direct
description: "Declare this turn's routing lane as handle-directly. The invocation itself is the verdict — it replaces the visible ROUTE line and puts the lane on the HUD."
argument-hint: "<one-line reason for this lane>"
---

# Lane: handle-directly

no delegation — answer or act in this context, zero skills and zero agents.
