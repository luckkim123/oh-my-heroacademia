---
name: route-omc
description: "Declare this turn's routing lane as oh-my-claudecode. The invocation itself is the verdict — it replaces the visible ROUTE line and puts the lane on the HUD."
argument-hint: "<one-line reason for this lane>"
---

# Lane: oh-my-claudecode

multi-agent orchestration and execution — team, autopilot, ralph, ultrawork, verify.
