---
name: route-sp
description: "Declare this turn's routing lane as superpowers. The invocation itself is the verdict — it replaces the visible ROUTE line and puts the lane on the HUD."
argument-hint: "<one-line reason for this lane>"
---

# Lane: superpowers

process discipline — brainstorming, writing-plans, TDD, systematic debugging.
